    ...
    uploadImage = async (image_uri) => {
        ...
        await axios
            ...
            .then(async (res) => {
                ...
                const url = "http://" + LocalIP + ":8888/accident";
                ...
                await axios
                    ...
                    .then(async (res) => {
                        ...
                        this.captureImage()
                        if (res.data.accident * 1 != 0 && this.state.accident_mode==false) {
                            this.setState({accident_mode:true})
                            const url2 = "http://" + ESP32IP + "/light_red"
                            axios.get(url2, {
                                headers: { "Content-Type": "application/json" },
                                timeout: 50000
                            }).then(async (res) => {
                                this.showNotification("Accident Detected! Red Lights ON")
                            }).catch((error) => {
                                this.showNotification("Accident Detected! Red Lights ON")
                            });
                        }
                    ...
                    <div class="card justify-content-center">
                        ...
                        <div class="x_scroll">
                            ...
                            <div class="col-md-4 offset-md-4">
                                <input type="submit" class="btn btn-outline-primary" value="Submit" onClick={this.startFun} />
                            </div>
                            <hr />
                            <div class="form-group row">
                                <div id='image_div'>
